...
create unique index user_cms_username_uindex on public.user_cms (username);

create view detailed_prize_redemptions
            (prize_id, prize, name, nik, msisdn, date_redeem,is_zonk, redeem_id, county, profession, date_validation, approved, lottery_number, amount, notes, receipt, sequence_number)
as
